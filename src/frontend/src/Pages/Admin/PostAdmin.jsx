...
const PostAdmin = () => {
	...
	return (
		<div className="">
			<h2 className="mb-2">Quản lý bài viết</h2>
								...
								<tbody>
									{posts.map((post, idx) => (
										<tr key={post._id}>
											...
											<td>
												<ul>
													<li className="fw-semibold"> {post.authorId?.displayName || post.authorId?.username || "N/A"}</li>
													<li className="fw-semibold">Tên đăng nhập: {post.authorId?.username || "N/A"}</li>
